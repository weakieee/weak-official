...
<body>
	...
	<div class="container">
<a href="https://sites.google.com/view/weakplaysofficial/home" target="_blank"><img src="images/IGN.png" alt="" width="200px" ></a><br><hr>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
		...
		<center><img src="upload_images/IGN.png" width="300px" height="300px" alt=""></center>
		<br><hr>
		<center><img src="upload_images/ingamenoobs.png" width="400px" height="200px" alt=""></center>
...
<input type="text" class="form-control" name="card_no" placeholder="Enter Student Id." maxlength="12" required>
</div>
<div class="form-group col-md-6">
...
<select name="state" class="form-control">
  ...
  <option value="Silay City">Silay City</option>
									...
									<option value="Binalbagan">Binabagan</option>
...
<input type="text" class="form-control" name="staff_id" maxlength="12" placeholder="Enter Staff Id">
</div>
